...
public class StudentsMapsActivity3 extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_students_maps3);
        ...
        mLogout.setOnClickListener(view -> {
            Intent intent = new Intent(StudentsMapsActivity3.this, SelectionPageActivity.class);
    ...
    Marker marker;
    void getBuses(){
        DatabaseReference driverLocation = FirebaseDatabase.getInstance().getReference().child("Users").child("Vehicle").child("Bus-3");
        ...
        geoquery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onGeoQueryReady() {
                if(!driverFound){
                    radius++;
                    if(radius>8587){
                        Toast.makeText(StudentsMapsActivity3.this, "No Location Found", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    getBuses();
                }
                else{
                    DatabaseReference show = FirebaseDatabase.getInstance().getReference().child("Users").child("Vehicle").child("Bus-3");
    ...
    protected void onStop() {
        super.onStop();
        String user_id = uId;
        Toast.makeText(StudentsMapsActivity3.this, "Bus-3", Toast.LENGTH_SHORT).show();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Request");
        GeoFire geofire = new GeoFire(ref);
